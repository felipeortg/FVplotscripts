...
irrep, spectrum1, t0str = spec.read_twopt_file(inter_file)
print(irrep, t0str)
print(spectrum1)
...
# for level in spectrum:
    #plot best fit
axis.errorbar(spectrum[:,0], spectrum[:,1], yerr=spectrum[:,2], 
             marker='_', mec='k', fillstyle='none', ecolor='k',elinewidth=1,capsize=10,zorder=4,
             alpha=1, ls='', label='data')

#plot bma
axis.errorbar(spectrum[:,0], spectrum[:,3], yerr=spectrum[:,4], 
             marker='_', mec='k', fillstyle='none', ecolor='k',elinewidth=1,capsize=10,zorder=4,
             alpha=0.5, ls='')       
